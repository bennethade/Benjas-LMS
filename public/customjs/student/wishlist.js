...
$(document).ready(function () {
    ...
    function loadWishlist(page = 1) {
        $.ajax({
            url: `/student/wishlist-data?page=${page}`,
            type: 'GET',
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a target="blank" href="/course-details/${item.course.course_name_slug}">${item.course.course_name}</a></h5>
                                    <p class="card-text"><a target="blank" href="/instructor/${item.course.user.first_name}/${item.course.user.id}">${item.course.user.first_name} ${item.course.user.surname}</a></p>
    ...
    wishlistContainer.on('click', '.delete-wishlist-item', function () {
        ...
        let url = `/student/wishlist/${wishlistId}`;
