                        ...
                        <form method="post" class="pt-4" action="{{route('login')}}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email"  value="{{ old('email') }}"  name="email" placeholder="Enter your email">
                            ...
                            <div class="btn-box">
                                ...
                                <button class="btn theme-btn" type="submit">Login Now <i class="la la-arrow-right icon ml-1"></i></button>
