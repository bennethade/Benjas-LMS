                  ...
                  <form method="post" class="pt-4" action="{{route('register')}}">
                     ...
                     <div class="input-box">
                        ...
                        <div class="form-group">
                           <input class="form-control form--control" type="text" name="first_name" placeholder="Enter first name" value="{{ old('first_name') }}">
                     ...
                     <div class="input-box">
                        ...
                        <div class="form-group">
                           <input class="form-control form--control" type="text" name="surname" placeholder="Enter surname" value="{{ old('surname') }}">
                           <span class="la la-user input-icon"></span>
                     ...
                     <div class="input-box">
                        ...
                        <div class="form-group">
                           <input class="form-control form--control" type="email" name="email" placeholder="Enter email address" value="{{ old('email') }}">
                     ...
                     <div class="input-box">
                        ...
                        <div class="input-group mb-3">
                           <span class="la la-lock input-icon"></span>
                           <input class="form-control form--control" type="password" name="password_confirmation" placeholder="Password">
