...
<div class="page-content">
        <!--breadcrumb-->
        @include('backend.section.breadcrumb', ['title' => 'Category', 'subtitle' => 'Update Category'])
        <!--end breadcrumb-->
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.category.update', $category->id) }}" enctype="multipart/form-data">
                            ...
                            {{-- @if ($category->image) --}}
                                <div class="col-md-6">
                                    <img src="{{ $category->image ? asset($category->image) : '' }}" id="photoPreview" width="60" height="60" style="margin-top: 15px;" alt="">
                                </div>
                            {{-- @endif --}}
