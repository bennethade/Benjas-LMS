            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        <h5 class="mb-4">Configure Stripe (Payment Gateway)</h5>
                    ...
                    <form class="row g-3" method="post" action="{{ route('admin.stripe.settings.update') }}">
                        ...
                        <div class="col-md-12">
                            <label for="public_key" class="form-label">Publishable Key</label>
                            <input type="text" class="form-control" name="public_key" id="public_key"
                                placeholder="Enter stripe publishable key"
                                value="{{ old('public_key', $stripeSettings->public_key ?? '') }}" required>
                        </div>
