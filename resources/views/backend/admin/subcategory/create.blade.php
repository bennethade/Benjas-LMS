...
<div class="page-content">
        <!--breadcrumb-->
        @include('backend.section.breadcrumb', ['title' => 'Subcategory', 'subtitle' => 'Add Subcategory'])
        <!--end breadcrumb-->
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.subcategory.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="slug" class="form-control" id="slug" placeholder="Subcategory Slug">
                            </div>
