            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('instructor.lecture.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="lecture_title" value="{{ old('lecture_title') }}" id="lecture-title" placeholder="Enter the lecture title" required>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function(){
            ...
            modal.addEventListener("hidden.bs.modal", function(){
                videoPreview.src ="";  //Reet video when modal closes
                videoPreview.style.display = "none";
            });
