...
<head>
	...
	<title>LMS - Instructor Login</title>
</head>
									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<input type="email" name="email" required value="{{ old('email') }}" class="form-control" id="inputEmailAddress" placeholder="jhon@example.com">
