<div class="tab-pane fade show active" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
    ...
    <form  class="col-md-12"  method="post" action="{{route('student.profile.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="setting-body">
            ...
            <div class="row mt-3">
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" placeholder="Enter your second name"  type="text" name="surname" value="{{ old('surname', auth()->user()->surname) }}" >
                        <span class="la la-user input-icon"></span>
                    </div>
                </div><!-- end input-box -->
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" type="text" placeholder="Enter your user name" name="name"  value="{{ old('name', auth()->user()->name) }}" >
                        <span class="la la-user input-icon"></span>
                    </div>
                </div><!-- end input-box -->
                <div class="input-box col-lg-6">
