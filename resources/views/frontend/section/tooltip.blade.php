        ...
        <div class="tooltip_templates">
            <div id="{{ $course->course_name_slug }}">
                <div class="card card-item">
                    <div class="card-body">
                        <p class="card-text pb-2">By <a href="teacher-detail.html">{{ $course['user']['first_name'] }} {{ $course['user']['surname'] }}</a></p>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn theme-btn flex-grow-1 mr-3 add-to-cart-btn" data-course-id="{{ $course->id }}">
